...
SEARCH_TOPICS: list[tuple[str, str]] = [
    ...
    ("旅行 vlog", "Du lịch"),
    ("风景", "Phong cảnh"),
    ("情感 语录", "Tâm sự/Tình cảm"),
    ("正能量", "Năng lượng tích cực"),
    ("感人 故事", "Chuyện cảm động"),
    ("剧情", "Tình huống kịch"),
    ("恶搞", "Chơi khăm"),
    ("整蛊", "Troll"),
    ("沙雕 日常", "Hài đời thường"),
    ("猫咪", "Mèo"),
    ("狗狗", "Chó"),
    ("萌娃", "Em bé"),
    ("育儿", "Nuôi dạy con"),
    ("生活 小妙招", "Mẹo vặt"),
    ("收纳 整理", "Dọn dẹp/Sắp xếp"),
    ("家居 装修", "Nhà cửa/Nội thất"),
    ("木工", "Nghề mộc"),
    ("解压", "Giải trí/ASMR"),
    ("手艺人", "Nghệ nhân"),
    ("非遗 传统", "Nghề truyền thống"),
    ("书法 绘画", "Thư pháp/Vẽ"),
    ("舞蹈", "Nhảy"),
    ("翻唱", "Cover nhạc"),
    ("乐器 演奏", "Chơi nhạc cụ"),
